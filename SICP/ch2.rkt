...
;     (define (make-from-mag-ang r a) (cons r a))
     ...
     (println (add-complex (make-from-mag-ang-polar 2 2)
                           (make-from-mag-ang-polar 2 2)))
     (println (add-complex (make-from-mag-ang-rectangular 1 (/ 3.1415926 2))
                           (make-from-mag-ang-rectangular 1 (/ 3.1415926 2))))
     (println (real-part-rectangular (contents (make-from-mag-ang-rectangular 1 (/ 3.1415926 2)))))
     (println (make-from-mag-ang-rectangular 1 (/ 3.1415926 2)))
