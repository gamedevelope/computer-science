...
((lambda ()
   ...
   (define (sets-as-binary-tree)
     ...
     (define set '())
     (set! set (adjoin-set 4 (adjoin-set 5 (adjoin-set 3 (adjoin-set 2 set)))))
     (println set)
     (println (element-of-set? 1 set))
     (println (element-of-set? 2 set))
     (println (element-of-set? 3 set))
     (println (element-of-set? 4 set))
     (println (element-of-set? 5 set))
     )
